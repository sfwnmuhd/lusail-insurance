...
const Footer3 = () => {
  ...
  return (
    <footer className="w-full bg-[#8B1538] ">
      <div className="mx-auto  px-20  container">
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
            ...
            <a
              href="#"
              className="py-2.5 px-5 h-9 block w-fit  rounded-full border text-xs text-white mx-auto transition-all duration-500  lg:mx-0"
            >
              Contact us
            </a>
          </div>
            ...
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="w-9 h-9 rounded-full bg-gray-700 dark:bg-gray-600 flex justify-center items-center hover:bg-[#8B1538] transition-colors duration-300"
                >
                  {link.icon}
                </a>
              ))}
